{
  ...
  hardware.fancontrol = {
    ...
    in ''
      ...
      MAXTEMP=hwmon1/pwm1=${GPU.maxTemp} hwmon1/pwm2=${CPU.maxTemp} hwmon1/pwm3=${CPU.maxTemp} hwmon1/pwm4=${caseFan.maxTemp} hwmon1/pwm5=${GPU.maxTemp}
      MINSTART=hwmon1/pwm1=${minStart} hwmon1/pwm2=${minStart} hwmon1/pwm3=${minStart} hwmon1/pwm4=${minStart} hwmon1/pwm5=${minStart}
      MINSTOP=hwmon1/pwm1=${minStop} hwmon1/pwm2=${minStop} hwmon1/pwm3=${minStop} hwmon1/pwm4=${minStop} hwmon1/pwm5=${minStop}
      MAXPWM=hwmon1/pwm1=${GPU.maxPWM} hwmon1/pwm2=${CPU.maxPWM} hwmon1/pwm3=${CPU.maxPWM} hwmon1/pwm4=${caseFan.maxPWM} hwmon1/pwm5=${GPU.maxPWM}
    '';
  };
