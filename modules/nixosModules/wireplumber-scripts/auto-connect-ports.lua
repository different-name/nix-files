...
function auto_connect_ports(args)
  local output_om = build_object_manager(
    args["output_subject"],
    args["output_left_port"],
    args["output_right_port"],
    "out"
  )

  local input_om = build_object_manager(
    args["input_subject"],
    args["input_left_port"],
    args["input_right_port"],
    "in"
  )
